...
const tabs: Tab[] = [
  {
    ...
    lines: [
      [
        ...
        { text: "fetch", cls: c.fn },
        { text: "(", cls: c.dim },
        { text: '"https://api.trychis.com/webhook/send"', cls: c.str },
        { text: ", {", cls: c.dim },
      ],
      [
  ...
  },
  {
    ...
    lines: [
      ...
      [
        { text: '  "payload": {"event": "payment.completed", "amount": 4999}', cls: c.str },
      ],
      [
        { text: "}`", cls: c.str },
        { text: ")", cls: c.dim },
  ...
  },
  {
    ...
    lines: [
      [
        ...
        { text: "https://api.trychis.com/webhook/send", cls: c.plain },
        { text: " \\", cls: c.dim },
      ],
      [
        { text: "  -H ", cls: c.dim },
        { text: '"X-API-Key: $CHIS_API_KEY"', cls: c.str },
        { text: " \\", cls: c.dim },
      ],
      [
        { text: "  -H ", cls: c.dim },
